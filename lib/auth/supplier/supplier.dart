...
import 'package:multi_vendor/auth/repeated_tab.dart';
import 'package:multi_vendor/auth/supplier/supplier_signin.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const AppBarTitle(title: 'Become a Seller',),
